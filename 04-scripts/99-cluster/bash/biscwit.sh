...
#SBATCH --array=0-99 ## number of jobs to run "in parallel" 
...
#SBATCH --job-name="biscwit_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=biscwit.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=biscwit.%A_%a.e
