...
#SBATCH --job-name="rf_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=rf.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
#SBATCH --error=rf.%A_%a.e
